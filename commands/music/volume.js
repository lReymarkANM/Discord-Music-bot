module.exports = {
    ...
    execute(client, message, args) {
        ...
        if (Math.round(parseInt(args[0])) < 1 || Math.round(parseInt(args[0])) > 1000) return message.channel.send(`${client.emotes.error} Please enter a valid number (between 1 and 1000)!`);
